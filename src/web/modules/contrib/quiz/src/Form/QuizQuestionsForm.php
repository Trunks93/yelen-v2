...
class QuizQuestionsForm extends FormBase {
   ...
   *   The quiz node.
   */
  public function _quiz_add_fields_for_creating_questions(&$form, &$types, Quiz $quiz) {
   ...
   *   of QuizQuestion
   */
  public function getSubQuestions($root_question, $all_questions) {
    $append = [];
   ...
   */
  public function sortQuestions($a, $b) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::messenger()->addMessage($this->t('Questions updated successfully.'));
    return;
   ...
   *   Quiz node(object).
   */
  public function _quiz_add_revision_checkbox(&$form, $quiz) {
   ...
   */
  public function _quiz_add_questions_to_form(&$form, &$questions, &$quiz, &$question_types) {
