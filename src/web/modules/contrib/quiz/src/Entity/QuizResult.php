...
class QuizResult extends ContentEntityBase implements EntityOwnerInterface, EntityChangedInterface {
   ...
   */
  public function maintainResults() {
    $db = \Drupal::database();
    $quiz = $this->getQuiz();
    $user = $this->getOwner();
   ...
   */
  public function setQuestion($question_number) {
   ...
   *   An empty QuizResult.
   */
  public function copyToQuizResult(QuizResult $result_new) {
